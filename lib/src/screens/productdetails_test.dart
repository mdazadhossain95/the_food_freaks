...
class ProductDetailsTest extends StatefulWidget {
  @override
  _ProductDetailsTestState createState() => _ProductDetailsTestState();
}

class _ProductDetailsTestState extends State<ProductDetailsTest> {
                    ...
                    Row(
                      children: [
                        const Padding(
                          ...
                          child: Text('Product Details', style: TextStyle(fontSize: 22),),
                        ),
                        const Spacer(),
                        IconButton(
