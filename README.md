...
<img src="documentation/image/01_login_page.png" width=40% height=40%>

## Sign Up Page 

To get started, users need to register. 

<img src="documentation/image/02_sign_up_page.png" width=40% height=40%>
...
<img src="documentation/image/05_home_2_page.png" width=40% height=40%>

## Menu Button 

Users can access several options when they click on the menu button, such as User Profile, Settings, and Logout. 

<img src="documentation/image/04_home_1_page.png" width=40% height=40%>
...
<img src="documentation/image/11_product_detail_page.png" width=40% height=40%>
...
<img src="documentation/image/12_cart_page.png" width=40% height=40%>
...
<img src="documentation/image/14_payment_page.png" width=40% height=40%>
